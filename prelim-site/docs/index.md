...
* Enhanced/New Features
    - Google Maps integration for church location services
    - Fully fleshed out search and filter features
    - More customization and editable features for members, individuals, and churches
    - More robust security for logins and for supabase entry
