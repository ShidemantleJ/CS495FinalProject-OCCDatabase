        ...
        <div className="max-w-md w-full bg-white shadow-xl rounded-3xl p-10 border-2 border-slate-200 text-center space-y-6">
          ...
          <form onSubmit={handleNextStep} className="space-y-4">
            <div className="text-left">
              <label className="block text-lg font-bold text-slate-700 mb-1 ml-2">
                Admin Email
              </label>
              <input
                type="email"
                ...
                onChange={(e) =>
                  setValidAdmin({ ...validAdmin, email: e.target.value })
                }
                required
              />
            </div>
            ...
            <div className="text-left">
              ...
              <input
                ...
                onChange={(e) =>
                  setValidAdmin({ ...validAdmin, password: e.target.value })
                }
                required
              />
            </div>
        ...
        <>
          ...
          >
            <div className="bg-white p-8 rounded-3xl shadow-xl border-2 border-slate-200">
              <div className="mb-8">
                <label className="block text-2xl font-bold text-slate-800 mb-3">
                  Person's Name
                </label>
                <input
                  type="text"
